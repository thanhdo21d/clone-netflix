...
export const getGenres = createAsyncThunk("netflix/genres", async () => {
    const { data: { genres } } = await axios.get(`${TMBP_BASE_URL}/genre/movie/list?api_key=${API_KEY}`);
    return genres;
});
...
export const fetchMovies = createAsyncThunk("netflix/trending", async ({ type }, thunkApi) => {
    ...
    return getRawData(`${TMBP_BASE_URL}/trending/${type}/week?api_key=${API_KEY}`, genres,
        true);
